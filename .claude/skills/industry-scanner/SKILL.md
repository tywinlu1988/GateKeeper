...
按 `references/guardrails/quality-gates.md` **全部**门禁逐项检查（当前为 G1-G9，含 G1.5 信号完备、G1.6 交叉信号一致性、G1.7 异议角色加权、G7 时效合规、G8 模板合规、G9 监控判定合规）。门禁清单的唯一事实源是 quality-gates.md——此处不复制完整清单，避免漂移。
